import { Controller, Get, Post, Body, Param, ParseIntPipe, UseInterceptors, UploadedFile, Res } from '@nestjs/common';
...
export class EmpresaController {
  ...
  @UseInterceptors(FileInterceptor('file', {
    storage: diskStorage({
      destination: './uploads', // Asegúrate que esta carpeta exista en la raíz del backend
